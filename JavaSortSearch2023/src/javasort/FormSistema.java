...
public class FormSistema extends javax.swing.JFrame {
   ...
   // Definir os comparadores
    ...
    void mostra(){
        //limpando a tabela
        tabelaDados.setModel(new DefaultTableModel(null,new String[]{"Data","Cidade","Condição","Tendencia","Minima","Maxima","Vento Min", "Vento Max", "Direção"}));
...
//          System.out.println("TempMin:"+d.getTemperaturaMinima()+"\n");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        dadoBusca.setCidade(txtSearch.getText());
        int r = -1;
